...
- [A Checklist to Publish Collections as Data in GLAM Institutions](https://www.glamlabs.io/checklist/) (2023)
...
If you’d like to get a sense of how people are reusing collections published as data, the [GLAM Workbench](https://glam-workbench.net/) and the new [computational access section of the International GLAM Labs Community website](https://www.glamlabs.io/computational-access-to-digital-collections) both have tutorials that can walk you through using cultural heritage datasets in a variety of ways.
