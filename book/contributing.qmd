...
Choose from our current wishlist below or propose a brand new one! Contact [digitalresearch@bl.uk](mailto:digitalresearch@bl.uk) with your idea or feel free to submit a proposal on the project GitHub by filling in our [**New Issue>Submission Tracker** Template](https://github.com/libereurope/ds-topic-guides/issues). Once your proposal is reviewed and approved we'll help you get started right away! Authors can submit drafts in either of two ways:
