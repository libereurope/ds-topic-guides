...
1. Choose from our current wishlist below or propose a brand new one! Not a member of a LIBER Member Institution? Not a problem, we will pair you up with a co-author from the LIBER network (https://libereurope.eu/liber-participants/) to ensure the european research library context is duly represented within the content. 
2. Contact [digitalresearch@bl.uk](mailto:digitalresearch@bl.uk) with your idea or feel free to submit a proposal directly on the project GitHub by filling in our [**New Issue>Submission Tracker** Template](https://github.com/libereurope/ds-topic-guides/issues). 
