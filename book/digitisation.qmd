...
### RTI
Reflectance Transformation Imaging (RTI), also known as Polynomial Texture Mapping (PTM), is a technique that creates hyper-real digital images with which the viewer can interact. It creates texture mapping by capturing multiple images of the subject from a fixed point whilst the light source varies in position. Standard imaging and lighting methods can cause glare and reflections on smooth or shiny surfaces, but RTI can also help capture the true colour of these surfaces as it reduces the impact of uneven lighting. This is really useful for revealing the textured detail in surfaces of objects such as coins, engravings or pressed plant material - there are some examples of a herbarium sheet in my [case-study](digitisation.qmd#d-and-other-multidimensional-media). This diagram shows a basic RTI set-up, you can learn more about the technique and process from the [Cultural Heritage Imaging's website about RTI](https://culturalheritageimaging.org/Technologies/RTI/).  
...
### RTI - Focussing on surface texture
3D models don’t work for everything. Capturing surface texture can be more useful when imaging flatter objects, or those with smooth reflective surfaces. For this, we use a technique called [RTI](#rti). 

Viewing RTI files often requires special desktop software, but through a recent research project called ['Small Performances Baskerville Punches'](https://baskervillepunches.org/), we have been able to incorporate the open-source [Relight Viewer](https://vcg.isti.cnr.it/vcgtools/relight/) into our digital library platform to enable viewing the digitised [Baskerville Punches](https://cudl.lib.cam.ac.uk/collections/baskervillepunches/1). This allows the user viewing an RTI image to move the light source, switch between surface representations, and adjust specular and diffuse reflection parameters in real time. You can see this and have a go yourself on this [Baskerville, 'h' punch](https://cudl.lib.cam.ac.uk/view/PR-BASKERVILLE-C-RLC-H-00060/1) and compare it to the standard images and 3D models as well. You can check out these articles If you want to learn more about ['How RTI Reveals the Secrets of Baskerville’s Punches'](https://baskervillepunches.org/how-rti-reveals-the-secrets-of-baskervilles-punches/) and ['Extending the Cambridge Digital Library Viewer: Supporting RTI](https://baskervillepunches.org/extending-the-cambridge-digital-library-viewer-supporting-rti/).

<iframe type='text/html' width='600' height='410' style='position: absolute; width: 100%; height: 100%;' src='https://cudl.lib.cam.ac.uk/embed/#item=PR-BASKERVILLE-C-RLC-H-00060&page=1&hide-info=true' frameborder='0' allowfullscreen='' onmousewheel=''></iframe>

### CT Scanning - Seeing inside!
You might also find that people want to see inside something! CT Scanning isn’t an everyday technique that we associate with research libraries, but you never know. The CT scan shown in the video below is of a fish specimen collected by Charles Darwin on the Beagle Voyage nearly 200 years ago. Preserved in alcohol in a jar, it's not very easy to inspect or study the real thing:    
