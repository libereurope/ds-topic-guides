...
- There are a range of data visualisation guides that can act to links to communities in US (university) libraries including [Harvard](https://library.harvard.edu/services-tools/visualization-support), [California Libraries Learn](https://callacademy.org/), [NC State University](https://www.lib.ncsu.edu/services/data-visualization), [Michigan State University](https://libguides.lib.msu.edu/c.php?g=966965&p=7019951)
...
- SCONUL (UK) have a community of interest for [business intelligence](https://www.sconul.ac.uk/cpd-hub/community-of-interest-groups/business-intelligence/) that covers analysing and visualising library data.

Above all remember your audience. Keep clear in your mind what you are trying to communicate, to whom, and ask whether your visualisation does that. Continue to refine until it does so, and good luck! 
